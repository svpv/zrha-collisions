...
// scaled-down ZrHa_update construction with ADD as the last combining step.
...
int main()
{
    const uint64_t seed = 0x10f9cfaac284a08d;
    const char s0[] = "_ZNSt4pairIK7QStringS0_EC1IRA6_KcRA9_S4_Lb1EEEOT_OT0_";
    const char s1[] = "_ZNSt4pairIK7QStringS0_EC1IRA7_KcRA8_S4_Lb1EEEOT_OT0_";
